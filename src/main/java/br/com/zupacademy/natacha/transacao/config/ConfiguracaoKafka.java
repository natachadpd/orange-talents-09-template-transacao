package br.com.zupacademy.natacha.transacao.config;

import br.com.zupacademy.natacha.transacao.transacao.EventoDeTransacao;
...
public class ConfiguracaoKafka {
    ...
    public ConfiguracaoKafka(KafkaProperties kafkaProperties) {
